...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Route.text_colour'
        db.delete_column('gtfs_route', 'text_colour')

        # Adding field 'Route.color'
        db.add_column('gtfs_route', 'color', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Route.text_colour'
        raise RuntimeError("Cannot reverse this migration. 'Route.text_colour' and its values cannot be restored.")

        # Deleting field 'Route.color'
        db.delete_column('gtfs_route', 'color')
    ...
    models = {
        ...
        'gtfs.route': {
            ...
            'text_color': ('django.db.models.fields.TextField', [], {}),
