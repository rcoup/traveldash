...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DashboardRoute.to_stop_code'
        db.add_column('mine_dashboardroute', 'to_stop_code', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Changing field 'DashboardRoute.from_stop'
        db.alter_column('mine_dashboardroute', 'from_stop_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['gtfs.Stop']))

        # Changing field 'DashboardRoute.to_stop'
        db.alter_column('mine_dashboardroute', 'to_stop_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['gtfs.Stop']))

        # Changing field 'DashboardRoute.walk_time_start'
        db.alter_column('mine_dashboardroute', 'walk_time_start', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'DashboardRoute.walk_time_end'
        db.alter_column('mine_dashboardroute', 'walk_time_end', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Dashboard.warning_time'
        db.alter_column('mine_dashboard', 'warning_time', self.gf('django.db.models.fields.PositiveIntegerField')())

        for dr in orm.DashboardRoute.objects.all():
            dr.from_stop_code = dr.from_stop.code
            dr.to_stop_code = dr.to_stop.code
            dr.save()
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DashboardRoute.from_stop'
        raise RuntimeError("Cannot reverse this migration. 'DashboardRoute.from_stop' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DashboardRoute.to_stop'
        raise RuntimeError("Cannot reverse this migration. 'DashboardRoute.to_stop' and its values cannot be restored.")

        # Changing field 'DashboardRoute.walk_time_start'
        db.alter_column('mine_dashboardroute', 'walk_time_start', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DashboardRoute.walk_time_end'
        db.alter_column('mine_dashboardroute', 'walk_time_end', self.gf('django.db.models.fields.IntegerField')())
