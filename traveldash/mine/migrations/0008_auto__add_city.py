...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'City'
        db.create_table('mine_city', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('map_center', self.gf('django.contrib.gis.db.models.fields.PointField')()),
            ('map_zoom', self.gf('django.db.models.fields.PositiveIntegerField')(default=11)),
        ))
        db.send_create_signal('mine', ['City'])


    def backwards(self, orm):
        
        # Deleting model 'City'
        db.delete_table('mine_city')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 9, 3, 19, 970202)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 9, 3, 19, 970089)'}),
