...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dashboard.city'
        db.add_column('mine_dashboard', 'city', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='dashboards', to=orm['mine.City']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dashboard.city'
        db.delete_column('mine_dashboard', 'city_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 17, 17, 47, 52, 250020)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 17, 17, 47, 52, 249905)'}),
