...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GTFSSource'
        db.create_table('mine_gtfssource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('web_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('zip_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('page_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('page_xpath', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('last_update', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('update_freq', self.gf('django.db.models.fields.IntegerField')(default=14, null=True)),
        ))
        db.send_create_signal('mine', ['GTFSSource'])

    def backwards(self, orm):

        # Deleting model 'GTFSSource'
        db.delete_table('mine_gtfssource')
